...
INVESTIGATIONS: List[Dict[str, Any]] = [
    {
        "id": "INV-2026-0001",
        "status": "completed",
        "lodged_at": "2018-01-06T10:15:00Z",
        "satellite": {
            "platform": "Sentinel-1",
            "product": "GRD",
            "timestamp": "2018-01-06T10:15:00Z",
        },
        "spill": {
            "confidence": 0.9,
            "area_km2": 286.0,
            "perimeter_km": 118.4,
            "centroid": {"lat": 31.38, "lon": 124.84},
            "major_axis_km": 48.6,
            "minor_axis_km": 12.4,
            "orientation_deg": 42,
            "polygon": "M 152,128 L 202,108 L 258,130 L 272,166 L 244,186 L 180,182 L 138,154 Z",
        },
        "source": {
            "lat": 31.42,
            "lon": 124.82,
            "window_start": "2018-01-04T12:00:00Z",
            "window_end": "2018-01-09T08:30:00Z",
        },
        "vessels": [
            {
                "mmsi": "357219004",
                ...
                "name": "MV SANCHI",
                "flag": "Panama",
                "vessel_type": "Very large crude carrier",
                "final_score": 0.94,
                "spatial": 0.96,
                "temporal": 0.91,
                "trajectory": 0.94,
                ...
                "time_diff_h": 0.8,
                "dwell_min": 58,
                "track": "M 126,186 L 148,168 L 174,154 L 204,142 L 228,136",
                "evidence": [
                    {"ok": True, "text": "Passed within 2.1 km of the known source location"},
                    {"ok": True, "text": "Within the multi-day release window across the East China Sea"},
                    {"ok": True, "text": "AIS track aligns with the drift vector over the full spill evolution"},
                    {"ok": True, "text": "The vessel remained in the source corridor long enough to explain a sustained release"},
                    {"ok": True, "text": "This is a documented real-world open-sea tanker spill case extended to show multi-day drift"},
                ],
            },
            {
                "mmsi": "412998231",
                ...
                "time_diff_h": 2.9,
                "dwell_min": 18,
                "track": "M 107,210 L 130,194 L 155,176 L 178,160",
                "evidence": [
                    {"ok": True, "text": "Passed within 9.4 km of the source zone"},
                    {"ok": True, "text": "Within the wider operating window"},
                    {"ok": None, "text": "Partially compatible drift and bearing"},
                ],
            },
            {
                "mmsi": "563102887",
                ...
                "time_diff_h": 7.2,
                "dwell_min": 6,
                "track": "M 254,112 L 246,132 L 236,150 L 224,164",
                "evidence": [
                    {"ok": None, "text": "19.8 km from the source zone"},
                    {"ok": False, "text": "Outside the strongest attribution window"},
                ],
            },
        ],
        "metrics": {
