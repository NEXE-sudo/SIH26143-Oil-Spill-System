...
export const REPORTS = [
  {
    ...
    spill: {
      ...
      orientation_deg: 42,
      polygon:
        "M 152,128 L 202,108 L 258,130 L 272,166 L 244,186 L 180,182 L 138,154 Z",
    },
    source: {
      lat: 31.42,
      lon: 124.82,
    ...
    vessels: [
      {
        ...
        evidence: [
          {
            ok: true,
            text: "Passed within 2.1 km of the known source location",
          },
          {
            ok: true,
            text: "Within the multi-day release window across the East China Sea",
          },
          {
            ok: true,
            text: "AIS track aligns with the drift vector over the full spill evolution",
          },
          {
            ok: true,
            text: "The vessel remained in the source corridor long enough to explain a sustained release",
          },
          {
            ok: true,
            text: "This is a documented real-world open-sea tanker spill case extended to show multi-day drift",
          },
        ],
      },
      {
        ...
        evidence: [
          ...
          { ok: null, text: "Partially compatible drift and bearing" },
        ],
      },
      {
        mmsi: "563102887",
        ...
        evidence: [
          { ok: null, text: "19.8 km from the source zone" },
