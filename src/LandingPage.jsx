...
export default function LandingPage({
  ...
  const visible = useMemo(() => {
    ...
    return [...list].sort(
      (a, b) => new Date(b.lodged_at) - new Date(a.lodged_at),
    );
  }, [recent, filter]);
    ...
    <div className="landing">
        ...
        <div className="brand">
          ...
          <div>
            ...
            <div className="brand-sub">
              SIH26143 · NTRO investigation console
            </div>
          </div>
        </div>
      ...
      <main className="landing-main">
        <div className="landing-heading">
          <h1>Reports</h1>
          <p>Historical detections and investigations available for review.</p>
        </div>
              ...
              >
                ...
                <div className="report-card-body">
                  <div className="report-field">
                    ...
                    <span className="report-field-value">
                      {r.spill.centroid.lat.toFixed(3)}°N,{" "}
                      {r.spill.centroid.lon.toFixed(3)}°E
                    </span>
                  </div>
                  <div className="report-field">
                ...
                <div className="report-card-footer">
                  <span className="report-lodged">
                    Lodged {fmtShortDateTime(r.lodged_at)}
                  </span>
                  {topVessel && (
                    <span
                    ...
                    >
                      {(topVessel.final_score * 100).toFixed(0)}% attribution
                      confidence
                    </span>
                  )}
                </div>
